...
public class ProjectEmployeeCostDTO {
    ...
    public ProjectEmployeeCostDTO(int project_id, String project_name, double budget, String project_description, int employee_id, int material_cost, int employee_cost) {
